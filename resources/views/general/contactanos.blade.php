...
.btn-submit {
    background-color: #800020; /* Granate */
    color: #fff;
    padding: 10px 20px;
    border: none;
    border-radius: 4px;
...
.btn-submit:hover {
    background-color: #a62c2b; /* Más claro para efecto hover */
}
...
.light-button button.wt .button-holder {
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
.light-button button.wt .button-holder svg {
  height: 50px;
  fill: #0f0f0f;
  transition: 300ms;
}

.light-button button.wt .light-holder {
  position: absolute;
  height: 200px;
  width: 100px;
  display: flex;
...
.light-button button.wt .light-holder .dot {
  position: absolute;
  top: 0;
  width: 10px;
  height: 10px;
...
.light-button button.wt .light-holder .light {
  position: absolute;
  top: 0;
  width: 200px;
  height: 200px;
...
.light-button button.wt:hover .button-holder svg {
  fill: rgba(0, 215, 87, 1);
}

.light-button button.wt:hover .button-holder {
  color: rgba(0, 215, 87, 1);
  outline: rgba(0, 215, 87, 1) 2px solid;
  outline-offset: 2px;
}

.light-button button.wt:hover .light-holder .light {
  background: rgb(255, 255, 255);
  background: linear-gradient(
    180deg,
    rgba(0, 215, 87, 1) 0%,
